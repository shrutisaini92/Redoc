# Redoc Demo OpenAPI Specification
[![Build Status](https://travis-ci.org/shrutisaini92/Redoc.svg?branch=master)](https://travis-ci.org/shrutisaini92/Redoc)
...
6. If you did everything correct, https://shrutisaini92.github.io/Redoc/ will lead to your new docs
...
- Documentation(ReDoc): https://shrutisaini92.github.io/Redoc/
- SwaggerUI: https://shrutisaini92.github.io/Redoc/swagger-ui/
- Look full spec:
    + JSON https://shrutisaini92.github.io/Redoc/swagger.json
    + YAML https://shrutisaini92.github.io/Redoc/swagger.yaml
- Preview spec version for branch `[branch]`: https://shrutisaini92.github.io/Redoc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://shrutisaini92.github.io/Redoc/ with url from the message: `Server started <url>`
